...
export const experience: Role[] = [
  {
    ...
    points: [
      ...
      "Built Frost, an agentic Hive-to-Iceberg migration platform with mandatory human approval gates, CI/CD promotion controls, durable workflow state, and audit records across GitLab, Jira, Slack, and Confluence. Migrated 450 tables across 40 workflows with no production incidents.",
